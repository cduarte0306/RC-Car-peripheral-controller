...
module SPI_Slave_v2_70_0 (
	...
	cy_clock_v1_0
		#(.id("e83e59fb-f979-408c-a5ec-10deddf70175/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=255, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=encoder_counter, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=encoder_counter, CY_INSTANCE_SHORT_NAME=encoder_counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=encoder_counter, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=2, CONTROL3=0, ControlRegRemoved=1, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC5, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=true, TriggerMode=1, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UsesHWEnable=1, VerilogSectionReplacementString=sT32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_echo_left, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_echo_left, CY_INSTANCE_SHORT_NAME=Timer_echo_left, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_echo_left, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=2, CONTROL3=0, ControlRegRemoved=1, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC5, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=true, TriggerMode=1, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UsesHWEnable=1, VerilogSectionReplacementString=sT32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_echo_front, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_echo_front, CY_INSTANCE_SHORT_NAME=Timer_echo_front, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_echo_front, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=10, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=60000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_trig, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_trig, CY_INSTANCE_SHORT_NAME=PWM_trig, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_trig, )
module PWM_v3_30_6 (
    capture,
    clock,
    cmp_sel,
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=2, CONTROL3=0, ControlRegRemoved=1, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC5, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=true, TriggerMode=1, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UsesHWEnable=1, VerilogSectionReplacementString=sT32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_echo_right, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_echo_right, CY_INSTANCE_SHORT_NAME=Timer_echo_right, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_echo_right, )
...
module I2C_v3_50_8 (
	...
	cy_clock_v1_0
		#(.id("65f18b60-a730-4dc7-8fd6-d01d9f97c692/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=2000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_Servo, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Servo, CY_INSTANCE_SHORT_NAME=PWM_Servo, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_Servo, )
module PWM_v3_30_9 (
    capture,
    clock,
    cmp_sel,
...
module top ;
	...
	cy_clock_v1_0
		#(.id("86897456-c48c-495d-959b-be3f14113f03"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ab293fb4-dc81-42db-8ba0-eed13add8688"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e47a3924-8f6e-4b7b-8ce9-722f5c4a9955"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("72537169-24cb-4576-9fe3-d5233f0fcad0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__steer_in_net;
	wire [0:0] tmpIO_0__steer_in_net;
	wire [0:0] tmpINTERRUPT_0__steer_in_net;
	electrical [0:0] tmpSIOVREF__steer_in_net;

	cy_psoc3_pins_v1_10
		#(.id("5cf50d2e-6aab-4254-b4f6-72ead0502ccd"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		steer_in
		 (.oe(tmpOE__steer_in_net),
		  .y({1'b0}),
		  .fb({Net_1721}),
		  .io({tmpIO_0__steer_in_net[0:0]}),
		  .siovref(tmpSIOVREF__steer_in_net),
		  .interrupt({tmpINTERRUPT_0__steer_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__steer_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__steer_out_net;
	wire [0:0] tmpFB_0__steer_out_net;
	wire [0:0] tmpIO_0__steer_out_net;
	wire [0:0] tmpINTERRUPT_0__steer_out_net;
	electrical [0:0] tmpSIOVREF__steer_out_net;

	cy_psoc3_pins_v1_10
		#(.id("bdae2fec-1798-4471-8a33-4302c43b1513"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		steer_out
		 (.oe(tmpOE__steer_out_net),
		  .y({Net_1720}),
		  .fb({tmpFB_0__steer_out_net[0:0]}),
		  .io({tmpIO_0__steer_out_net[0:0]}),
		  .siovref(tmpSIOVREF__steer_out_net),
		  .interrupt({tmpINTERRUPT_0__steer_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__steer_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    BasicCounter_v1_0 TIME_COUNTER (
        .clock(clock_1),
        .cnt(Net_622[31:0]),
        .en(Net_155),
        .reset(Net_154));
    defparam TIME_COUNTER.Width = 32;

    CyStatusReg_v1_90 TREG0 (
        .clock(clock_1),
        .intr(Net_156),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_622[7:0]));
    defparam TREG0.Bit0Mode = 0;
    defparam TREG0.Bit1Mode = 0;
    defparam TREG0.Bit2Mode = 0;
    defparam TREG0.Bit3Mode = 0;
    defparam TREG0.Bit4Mode = 0;
    defparam TREG0.Bit5Mode = 0;
    defparam TREG0.Bit6Mode = 0;
    defparam TREG0.Bit7Mode = 0;
    defparam TREG0.BusDisplay = 1;
    defparam TREG0.Interrupt = 0;
    defparam TREG0.MaskValue = 0;
    defparam TREG0.NumInputs = 8;

    CyStatusReg_v1_90 TREG1 (
        .clock(clock_1),
        .intr(Net_165),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_622[15:8]));
    defparam TREG1.Bit0Mode = 0;
    defparam TREG1.Bit1Mode = 0;
    defparam TREG1.Bit2Mode = 0;
    defparam TREG1.Bit3Mode = 0;
    defparam TREG1.Bit4Mode = 0;
    defparam TREG1.Bit5Mode = 0;
    defparam TREG1.Bit6Mode = 0;
    defparam TREG1.Bit7Mode = 0;
    defparam TREG1.BusDisplay = 1;
    defparam TREG1.Interrupt = 0;
    defparam TREG1.MaskValue = 0;
    defparam TREG1.NumInputs = 8;

    CyStatusReg_v1_90 TREG2 (
        .clock(clock_1),
        .intr(Net_174),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_622[23:16]));
    defparam TREG2.Bit0Mode = 0;
    defparam TREG2.Bit1Mode = 0;
    defparam TREG2.Bit2Mode = 0;
    defparam TREG2.Bit3Mode = 0;
    defparam TREG2.Bit4Mode = 0;
    defparam TREG2.Bit5Mode = 0;
    defparam TREG2.Bit6Mode = 0;
    defparam TREG2.Bit7Mode = 0;
    defparam TREG2.BusDisplay = 1;
    defparam TREG2.Interrupt = 0;
    defparam TREG2.MaskValue = 0;
    defparam TREG2.NumInputs = 8;

    CyStatusReg_v1_90 TREG3 (
        .clock(clock_1),
        .intr(Net_183),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_622[31:24]));
    defparam TREG3.Bit0Mode = 0;
    defparam TREG3.Bit1Mode = 0;
    defparam TREG3.Bit2Mode = 0;
    defparam TREG3.Bit3Mode = 0;
    defparam TREG3.Bit4Mode = 0;
    defparam TREG3.Bit5Mode = 0;
    defparam TREG3.Bit6Mode = 0;
    defparam TREG3.Bit7Mode = 0;
    defparam TREG3.BusDisplay = 1;
    defparam TREG3.Interrupt = 0;
    defparam TREG3.MaskValue = 0;
    defparam TREG3.NumInputs = 8;
    ...
    Counter_v3_0_3 encoder_counter (
        .capture(1'b0),
        .clock(clock_2),
        .comp(Net_2477),
        .count(enc_in),
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam encoder_counter.CaptureMode = 0;
    defparam encoder_counter.ClockMode = 0;
    defparam encoder_counter.CompareMode = 1;
    defparam encoder_counter.CompareStatusEdgeSense = 1;
    defparam encoder_counter.EnableMode = 0;
    defparam encoder_counter.ReloadOnCapture = 0;
    defparam encoder_counter.ReloadOnCompare = 0;
    defparam encoder_counter.ReloadOnOverUnder = 1;
    defparam encoder_counter.ReloadOnReset = 1;
    defparam encoder_counter.Resolution = 32;
    defparam encoder_counter.RunMode = 0;
    defparam encoder_counter.UseInterrupt = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("ffe18fa6-bc6a-41c0-a814-87f84780627f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("20e8c6e9-c5c4-4129-b62d-c27df0139d17"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 motor_sel (
        ...
        .control_7(Net_1133),
        .reset(1'b0));
    defparam motor_sel.Bit0Mode = 0;
    defparam motor_sel.Bit1Mode = 0;
    defparam motor_sel.Bit2Mode = 0;
    defparam motor_sel.Bit3Mode = 0;
    defparam motor_sel.Bit4Mode = 0;
    defparam motor_sel.Bit5Mode = 0;
    defparam motor_sel.Bit6Mode = 0;
    defparam motor_sel.Bit7Mode = 0;
    defparam motor_sel.BitValue = 0;
    defparam motor_sel.BusDisplay = 0;
    defparam motor_sel.ExtrReset = 0;
    defparam motor_sel.NumOutputs = 1;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_236 or Net_237 or Net_242)
        begin
            case (Net_242)
                1'b0 :  tmp__mux_1_reg = Net_236;
                1'b1 :  tmp__mux_1_reg = Net_237;
            endcase
        end
        assign pwm_out_bus = tmp__mux_1_reg;
    end
    // -- Mux end --

	wire [0:0] tmpOE__front_echo_net;
	wire [0:0] tmpIO_0__front_echo_net;
	wire [0:0] tmpINTERRUPT_0__front_echo_net;
	electrical [0:0] tmpSIOVREF__front_echo_net;

	cy_psoc3_pins_v1_10
		#(.id("15974570-2c69-4242-b9a1-b940ec07a21b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		front_echo
		 (.oe(tmpOE__front_echo_net),
		  .y({1'b0}),
		  .fb({Net_928}),
		  .io({tmpIO_0__front_echo_net[0:0]}),
		  .siovref(tmpSIOVREF__front_echo_net),
		  .interrupt({tmpINTERRUPT_0__front_echo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__front_echo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_1 (
        .z(Net_82));

    assign Net_1123 = 1'h0;
    ...
    Timer_v2_80_4 Timer_echo_left (
        ...
        .tc(Net_936),
        .trigger(Net_917));
    defparam Timer_echo_left.CaptureCount = 2;
    defparam Timer_echo_left.CaptureCounterEnabled = 0;
    defparam Timer_echo_left.DeviceFamily = "PSoC5";
    defparam Timer_echo_left.InterruptOnCapture = 1;
    defparam Timer_echo_left.InterruptOnTC = 0;
    defparam Timer_echo_left.Resolution = 32;
    defparam Timer_echo_left.SiliconRevision = "0";

    assign Net_930 = 1'h1;

	wire [0:0] tmpOE__right_echo_net;
	wire [0:0] tmpIO_0__right_echo_net;
	wire [0:0] tmpINTERRUPT_0__right_echo_net;
	electrical [0:0] tmpSIOVREF__right_echo_net;

	cy_psoc3_pins_v1_10
		#(.id("d0f22e5c-7af6-44c5-963c-b3f2c69e5e26"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		right_echo
		 (.oe(tmpOE__right_echo_net),
		  .y({1'b0}),
		  .fb({Net_921}),
		  .io({tmpIO_0__right_echo_net[0:0]}),
		  .siovref(tmpSIOVREF__right_echo_net),
		  .interrupt({tmpINTERRUPT_0__right_echo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__right_echo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_5 Timer_echo_front (
        .capture(Net_928),
        .capture_out(Net_953),
        .clock(timer_us),
        .enable(Net_930),
        ...
        .tc(Net_954),
        .trigger(Net_928));
    defparam Timer_echo_front.CaptureCount = 2;
    defparam Timer_echo_front.CaptureCounterEnabled = 0;
    defparam Timer_echo_front.DeviceFamily = "PSoC5";
    defparam Timer_echo_front.InterruptOnCapture = 1;
    defparam Timer_echo_front.InterruptOnTC = 0;
    defparam Timer_echo_front.Resolution = 32;
    defparam Timer_echo_front.SiliconRevision = "0";

    assign Net_580 = 1'h1;

    PWM_v3_30_6 PWM_trig (
        .capture(1'b0),
        .clock(Net_686),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_1006),
        .trigger(1'b0));
    defparam PWM_trig.Resolution = 16;


	cy_clock_v1_0
		#(.id("0112c257-1366-4825-b69d-0745690e0cde"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("31c76910-0d9f-42a6-befa-90d4787c6b6f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_80_7 Timer_echo_right (
        .capture(Net_921),
        .capture_out(Net_950),
        .clock(timer_us),
        .enable(Net_923),
        ...
        .tc(Net_951),
        .trigger(Net_921));
    defparam Timer_echo_right.CaptureCount = 2;
    defparam Timer_echo_right.CaptureCounterEnabled = 0;
    defparam Timer_echo_right.DeviceFamily = "PSoC5";
    defparam Timer_echo_right.InterruptOnCapture = 1;
    defparam Timer_echo_right.InterruptOnTC = 0;
    defparam Timer_echo_right.Resolution = 32;
    defparam Timer_echo_right.SiliconRevision = "0";

	wire [0:0] tmpOE__left_echo_net;
	wire [0:0] tmpIO_0__left_echo_net;
	wire [0:0] tmpINTERRUPT_0__left_echo_net;
	electrical [0:0] tmpSIOVREF__left_echo_net;

	cy_psoc3_pins_v1_10
		#(.id("0c7df4cd-4136-40c0-b521-331f1b3563e9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		left_echo
		 (.oe(tmpOE__left_echo_net),
		  .y({1'b0}),
		  .fb({Net_917}),
		  .io({tmpIO_0__left_echo_net[0:0]}),
		  .siovref(tmpSIOVREF__left_echo_net),
		  .interrupt({tmpINTERRUPT_0__left_echo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__left_echo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("c9850a64-fbb1-46b4-9a14-d8f099f29cd2"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__imu_int_pin_net;
	wire [0:0] tmpIO_0__imu_int_pin_net;
	wire [0:0] tmpINTERRUPT_0__imu_int_pin_net;
	electrical [0:0] tmpSIOVREF__imu_int_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("d6221281-68d8-47d5-b1e9-54636cebdf33"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		imu_int_pin
		 (.oe(tmpOE__imu_int_pin_net),
		  .y({1'b0}),
		  .fb({Net_1024}),
		  .io({tmpIO_0__imu_int_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__imu_int_pin_net),
		  .interrupt({tmpINTERRUPT_0__imu_int_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__imu_int_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__encoder_in_net;
	wire [0:0] tmpIO_0__encoder_in_net;
	wire [0:0] tmpINTERRUPT_0__encoder_in_net;
	electrical [0:0] tmpSIOVREF__encoder_in_net;

	cy_psoc3_pins_v1_10
		#(.id("36e1b3f8-970b-4caa-8e90-9d81a2c277dd"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		encoder_in
		 (.oe(tmpOE__encoder_in_net),
		  .y({1'b0}),
		  .fb({enc_in}),
		  .io({tmpIO_0__encoder_in_net[0:0]}),
		  .siovref(tmpSIOVREF__encoder_in_net),
		  .interrupt({tmpINTERRUPT_0__encoder_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__encoder_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("bdf1d618-4625-4dd5-90b2-721e6478eb24"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000"),
		  .is_direct(0),
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_1168 or Net_1169 or sim_sel_bus)
        begin
            case (sim_sel_bus)
                1'b0 :  tmp__mux_2_reg = Net_1168;
                1'b1 :  tmp__mux_2_reg = Net_1169;
            endcase
        end
        assign Net_1167 = tmp__mux_2_reg;
    end
    // -- Mux end --


    assign Net_1427 = ~Net_1167;

	wire [0:0] tmpOE__dir_sel_net;
	wire [0:0] tmpIO_0__dir_sel_net;
	wire [0:0] tmpINTERRUPT_0__dir_sel_net;
	electrical [0:0] tmpSIOVREF__dir_sel_net;

	cy_psoc3_pins_v1_10
		#(.id("35324831-846f-422b-bae6-74f5a7da197a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		dir_sel
		 (.oe(tmpOE__dir_sel_net),
		  .y({1'b0}),
		  .fb({Net_1168}),
		  .io({tmpIO_0__dir_sel_net[0:0]}),
		  .siovref(tmpSIOVREF__dir_sel_net),
		  .interrupt({tmpINTERRUPT_0__dir_sel_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__dir_sel_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 dir_ctrl (
        .clock(1'b0),
        .control_0(Net_1169),
        .control_1(Net_1374),
        .control_2(Net_1375),
        ...
        .control_7(Net_1380),
        .reset(1'b0));
    defparam dir_ctrl.Bit0Mode = 0;
    defparam dir_ctrl.Bit1Mode = 0;
    defparam dir_ctrl.Bit2Mode = 0;
    defparam dir_ctrl.Bit3Mode = 0;
    defparam dir_ctrl.Bit4Mode = 0;
    defparam dir_ctrl.Bit5Mode = 0;
    defparam dir_ctrl.Bit6Mode = 0;
    defparam dir_ctrl.Bit7Mode = 0;
    defparam dir_ctrl.BitValue = 0;
    defparam dir_ctrl.BusDisplay = 0;
    defparam dir_ctrl.ExtrReset = 0;
    defparam dir_ctrl.NumOutputs = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("992f382e-539b-4faf-ab3a-261fa98377ea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a8dc349b-2aee-498e-bc14-d6830d442429"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_1658 = 1'h0;

    // -- Mux start --
    if (1)
    begin : mux_3
        reg  tmp__mux_3_reg;
        always @(Net_1721 or Net_1722 or sim_sel_bus)
        begin
            case (sim_sel_bus)
                1'b0 :  tmp__mux_3_reg = Net_1721;
                1'b1 :  tmp__mux_3_reg = Net_1722;
            endcase
        end
        assign Net_1720 = tmp__mux_3_reg;
    end
    // -- Mux end --

    CyControlReg_v1_80 sim_sel (
        .clock(1'b0),
        .control_0(sim_sel_bus),
        .control_1(Net_1813),
        .control_2(Net_1814),
        .control_3(Net_1815),
        .control_4(Net_1816),
        ...
        .control_7(Net_1819),
        .reset(1'b0));
    defparam sim_sel.Bit0Mode = 0;
    defparam sim_sel.Bit1Mode = 0;
    defparam sim_sel.Bit2Mode = 0;
    defparam sim_sel.Bit3Mode = 0;
    defparam sim_sel.Bit4Mode = 0;
    defparam sim_sel.Bit5Mode = 0;
    defparam sim_sel.Bit6Mode = 0;
    defparam sim_sel.Bit7Mode = 0;
    defparam sim_sel.BitValue = 0;
    defparam sim_sel.BusDisplay = 0;
    defparam sim_sel.ExtrReset = 0;
    defparam sim_sel.NumOutputs = 1;


	cy_clock_v1_0
		#(.id("58484006-da12-4c7b-9154-18a30b9aa123"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
    ...
    assign Net_1676 = 1'h0;

    Counter_v3_0_10 encoder_health_counter (
        .capture(1'b0),
        .clock(clock_2),
        .comp(Net_2516),
        .count(pwm_out_bus),
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam encoder_health_counter.CaptureMode = 0;
    defparam encoder_health_counter.ClockMode = 0;
    defparam encoder_health_counter.CompareMode = 1;
    defparam encoder_health_counter.CompareStatusEdgeSense = 1;
    defparam encoder_health_counter.EnableMode = 0;
    defparam encoder_health_counter.ReloadOnCapture = 0;
    defparam encoder_health_counter.ReloadOnCompare = 0;
    defparam encoder_health_counter.ReloadOnOverUnder = 1;
    defparam encoder_health_counter.ReloadOnReset = 1;
    defparam encoder_health_counter.Resolution = 16;
    defparam encoder_health_counter.RunMode = 0;
    defparam encoder_health_counter.UseInterrupt = 1;
